# Log histórico de sessões — CLAUDE.md (2026-07-27 a 2026-08-21)

**Arquivo morto**, mesmo espírito de `docs/historico/` descrito no próprio
CLAUDE.md: notas de sessão movidas pra fora do arquivo principal em
2026-08-21 (ver `docs/RELATORIO-OTIMIZACAO-CLAUDE-MD-2026-08-21.md`) porque
o CLAUDE.md tinha crescido para ~90% de log cronológico — carregado inteiro
em toda sessão nova, sem necessidade, já que quase todo fato aqui dentro
que ainda importa hoje foi condensado de volta nas seções de referência do
CLAUDE.md (Regras de negócio, Convenções de código, UI/Frontend, Deploy
etc.).

**Não é fonte da verdade para nada — só arqueologia.** Se um fato aqui
parecer contradizer o CLAUDE.md atual, o CLAUDE.md vence sempre; este
arquivo é só o histórico de COMO/QUANDO cada coisa foi decidida ou
corrigida, útil pra quem quiser entender o raciocínio por trás de uma
regra atual, não pra saber o que é verdade hoje. Preservado literalmente,
sessão por sessão, sem edição — só extraído do CLAUDE.md em bloco.
