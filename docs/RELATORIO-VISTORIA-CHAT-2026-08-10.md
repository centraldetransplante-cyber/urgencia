...
| **F5** | **S7.1** (simetria de `podeEnviar` no canal do solicitante) | A8 | **Baixo-médio** | **SIM (Q4)** | Sim (leve) | **PR ABERTO** (2026-08-10, ver CLAUDE.md — decisão Q4 confirmada no sentido OPOSTO à recomendação original: afrouxa o solicitante, não restringe o operador) |
